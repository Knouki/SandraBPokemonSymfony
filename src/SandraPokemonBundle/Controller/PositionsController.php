...
use SandraPokemonBundle\Entity\Positions;
use SandraPokemonBundle\Form\PositionsType;
...
class PositionsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $positions = $em->getRepository('SandraPokemonBundle:Positions')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SandraPokemonBundle\Form\PositionsType', $position);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('positions_show', array('id' => $position->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($position);
        $editForm = $this->createForm('SandraPokemonBundle\Form\PositionsType', $position);
