...
use SandraPokemonBundle\Entity\Objets;
use SandraPokemonBundle\Form\ObjetsType;
...
class ObjetsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $objets = $em->getRepository('SandraPokemonBundle:Objets')->findAll();
    ...
    {
        $objet = new Objets();
        $form = $this->createForm('SandraPokemonBundle\Form\ObjetsType', $objet);
    ...
    {
        $deleteForm = $this->createDeleteForm($objet);
        $editForm = $this->createForm('SandraPokemonBundle\Form\ObjetsType', $objet);
